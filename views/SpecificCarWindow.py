...
class SpecificCarWindow(QWidget):
    ...
    def __init__(self):
        ...
        # cariables used to make a reservation
        self.license_plate = ""
        self.rental_dates = []

        # Guide prompt
        self.guide_label = QLabel("Choose Start and End Dates of Desired Rental Period")
    ...
    # admin/empoyees have to login/create a user account to make a reservation
    # clients must be logged into an acount to create a reseravtion
    def reserve(self):
